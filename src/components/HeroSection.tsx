...
import { Satellite, ArrowRight, ShoppingCart } from "lucide-react";
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                onClick={() => trackLead("Hero Section")}
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-foreground bg-secondary hover:bg-accent transition-colors text-base"
