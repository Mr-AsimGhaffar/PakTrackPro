      ...
      <div className="section-container">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Experience cutting-edge satellite tracking technology designed for reliability,
          ...
          {productData.features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group card-elevated card-hover p-6 lg:p-8"
              >
                {/* Icon */}
        ...
        >
          <p className="text-muted-foreground mb-6">
            Ready to secure your assets with the best tracking technology?
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <motion.a
              ...
              onClick={() => trackLead("Features Section")}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-border bg-background font-semibold text-foreground transition-colors hover:bg-accent"
